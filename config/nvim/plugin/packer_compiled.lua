...
_G.packer_plugins = {
  ...
  ["vifm.vim"] = {
    ...
    url = "https://github.com/istib/vifm.vim"
  },
  ["vim-floaterm"] = {
    loaded = true,
...
vim.cmd [[au FileType javascript ++once lua require("packer.load")({'cmp-npm', 'react-nextjs-snippets', 'package-info.nvim'}, { ft = "javascript" }, _G.packer_plugins)]]
